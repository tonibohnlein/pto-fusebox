...
The current executable writes the versioned `pto_fusebox.solution.v7` schema.
...
```json
{
  "schema_version": "pto_fusebox.solution.v7",
  "steps": [
    {
      "kind": "cube",
      "ops": [0, 1],
...
current executable serializes the equivalent choices as nested `solution.v7`
